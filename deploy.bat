 @echo off
REM Crear el archivo conn_string.txt con los datos de conexión SIN SALTO DE LÍNEA
<NUL (SET /P X="CONN_STRING=sys/Oracle123@oracle-db-container:1521/xepdb1") > "ords\ords_secrets\conn_string.txt"
